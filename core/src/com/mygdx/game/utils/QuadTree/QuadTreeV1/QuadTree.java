...
public class QuadTree<T> {
    ...
    private int findRegion(Rectangle r, boolean split) {
    ...
    private void split() {
        ...
        regions[REGION_NW] = new QuadTree<T>(new Rectangle(
                zone.x,
        ...
        regions[REGION_NE] = new QuadTree<T>(new Rectangle(
                zone.x + zone.width / 2,
                zone.y + zone.height / 2,
                newWidth,
                newHeight
        ...
        regions[REGION_SW] = new QuadTree<T>(new Rectangle(
                zone.x,
                zone.y,
                newWidth,
                newHeight
        ...
        regions[REGION_SE] = new QuadTree<T>(new Rectangle(
                zone.x + zone.width / 2,
                zone.y,
                newWidth,
                newHeight
    ...
    public void getAllZones(ArrayList<Rectangle> list) {
        list.add(this.zone);
        if (regions != null) {
